...
static const int64_t HARD_SYNC_THRESHOLD_US = 25000;
static const int64_t HARD_SYNC_SETTLE_THRESHOLD_US = 5000;  // Tighter threshold used while settling after a hard sync
